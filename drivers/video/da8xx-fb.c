...
static struct da8xx_panel known_lcd_panels[] = {
	...
	[7] = {
		...
		.vbp = 20,
		.vsw = 5,
		.pxl_clk = 64000000,    //63800000  //74250000
		.invert_pxl_clk = 0,   
	},     //aoc
	[8] = {
		 /* 1024 x 768 @ 60 Hz  Reduced blanking VESA CVT 0.79M3-R */
		.name = "nxp-1024x768@60",
		.width = 1024,
		.height = 768,
		.hfp = 28, // 23                              //25
		.hbp = 158, // 190                         //234
		...
		.vbp = 28,   //29
		.vsw = 5,    //5
		.pxl_clk = 64000000,//62400000
		.invert_pxl_clk = 0,        //wince
	},
	[9] = {
